...
export function imagenPrincipal(propiedad) {
  // `imagen_portada` viene de la entidad IMAGEN (es_portada = true).
  // Si no hay portada marcada, se usa la primera de la galería.
  return propiedad?.imagen_portada || propiedad?.imagenes?.[0] || PLACEHOLDER_IMG
}
